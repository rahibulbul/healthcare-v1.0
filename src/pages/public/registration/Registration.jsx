...
import { checkUsernameAvailability, registerUser } from "../../../api/authService"
...
export default function Registration() {
  ...
  const [, setIsPasswordTouched] = useState(false);
  const [, setIsConfirmPasswordTouched] =
    useState(false);
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (
      ...
      try {
        ...
        const userId = await registerUser(userData, userType, year, month, userPrefix);
      ...
      <div className="web-container w-full h-full registration flex flex-col items-center">
        ...
        >
          ...
          <div className="registration-input-group">
            <div
              className={`registration-input ${fullnameError && isFullnameTouched ? "error" : ""
                }`}
            >
              <input
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${fullnameError && isFullnameTouched ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
            ...
            {/* Email Field */}
            <div
              className={`registration-input ${emailError && isEmailTouched ? "error" : ""
                }`}
            >
              <input
                className="registration-inputBox"
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${emailError && isEmailTouched ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
          ...
          <div className="registration-input-group">
            <div
              className={`registration-input ${usernameError && isUsernameTouched ? "error" : ""
                }`}
            >
              <input
                className="registration-inputBox"
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${usernameError && isUsernameTouched ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
            ...
            {/* User Type Field */}
            <div
              className={`registration-input ${userTypeError && isUserTypeTouched ? "error" : ""
                }`}
            >
              <select
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${userTypeError && isUserTypeTouched ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
                className={`icon-check-circle ${!userTypeError && userType ? "" : "hidden"
                  }`}
              />
          ...
          <div className="registration-input-group">
            <div
              className={`registration-input registration-input-password ${passwordError.message !== "Enter your password" ? "error" : ""
                }`}
            >
              <input
                className="registration-inputBox"
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${passwordError.color === "#e74c3c" ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
                className={`icon-check-circle ${isPasswordMatched && isPasswordValid ? "" : "hidden"
                  }`}
              />
            ...
            <div
              className={`registration-input registration-input-password ${confirmPasswordError.message !== "Enter your password"
                ? "error"
                : ""
                }`}
            >
              ...
              <span className="password-strength-panel">
                ...
                <div className="password-strength-indicator">
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
                      className={`strength-bar ${i < confirmPasswordStrength ? "active" : ""
                        }`}
                      style={{
                        backgroundColor:
              ...
              <FaExclamationCircle
                className={`icon-exclamation ${confirmPasswordError.color === "#e74c3c" ? "" : "hidden"
                  }`}
              />
              <FaCheckCircle
                className={`icon-check-circle ${isPasswordMatched && isPasswordValid ? "" : "hidden"
          ...
          <div className="form-registration-terms">
            ...
            <div
              className={`registration-terms-panel ${showTermsPanel ? "show" : ""
                }`}
            >
